...
object ChunkRenderData {
  ...
  def empty: ChunkRenderData = new ChunkRenderData(IndexedSeq.fill(8)(null), IndexedSeq.fill(8)(null))
}

case class ChunkRenderData(
    opaqueBlockDataPerSide: IndexedSeq[ByteBuffer],
    translucentBlockDataPerSide: IndexedSeq[ByteBuffer]
)
