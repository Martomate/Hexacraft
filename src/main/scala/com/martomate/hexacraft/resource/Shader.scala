...
object Shader {
  ...
  def init(): Unit = {
    ...
    Shader("entity", fileName = "entity_part")("position", "texCoords", "normal", "modelMatrix", "", "", "", "blockTex", "brightness")("isSide" -> "0")
    Shader("entitySide", fileName = "entity_part")("position", "texCoords", "normal", "modelMatrix", "", "", "", "blockTex", "brightness")("isSide" -> "1")
