...
class ChunkRenderSelectorIdentity(handler: ChunkRenderHandler)
    extends ChunkRenderSelector(handler) {
...
class ChunkRenderSelectorNotBuried(handler: ChunkRenderHandler)
    extends ChunkRenderSelector(handler) {
